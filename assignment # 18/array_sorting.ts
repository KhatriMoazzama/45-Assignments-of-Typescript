...
const s_countries = countries.slice().sort()
console.log(s_countries)
console.log("\n original order \n" )
console.log(countries)
const r_Countries = countries.slice().sort().reverse()
...
const a_sorted_list = countries.sort()
console.log(a_sorted_list)
console.log("\n Reverse alphabetical order \n")
const r_a_list = a_sorted_list.reverse()
